...
CREATE TABLE `tbl_favoritos` (
  ...
  PRIMARY KEY (`ID`),
  KEY `USUARIOFAVORITO_idx` (`ID_USUARIO`),
  KEY `ARTICULOFAVORITO_idx` (`ID_ARTICULO`),
  CONSTRAINT `ARTICULOFAVORITO` FOREIGN KEY (`ID_ARTICULO`) REFERENCES `tbl_articulos` (`ID`),
  CONSTRAINT `USUARIOFAVORITO` FOREIGN KEY (`ID_USUARIO`) REFERENCES `tbl_usuarios` (`ID`)
